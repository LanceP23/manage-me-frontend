...
export default function DraftDetailClient({ draftId }: DraftDetailClientProps) {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      {notice ? (
        <div className="rounded-xl border border-[var(--mm-border)] bg-[rgba(89,219,181,0.08)] px-4 py-3 text-sm text-[#9ff4de]">
          {notice}
        </div>
      ) : null}
      ...
      <div className="mm-grid cols-2">
        ...
        <Card eyebrow="Resolution" title="What should happen next">
                      ...
                      <Button
                        ...
                        onClick={async () => {
                          ...
                          try {
                            ...
                            setNotice(
                              `Draft resolved into existing ticket #${result.mergedIntoTicket.id}. It has been removed from the pending queue.`,
                            );
                    ...
                    <Button
                      ...
                      onClick={async () => {
                        ...
                        try {
                          ...
                          setDraft(result);
                          setNotice("Draft rejected. It has been removed from the pending queue.");
                          const auditResponse = await getDraftAudit(token, String(draft.id), orgId);
                          setAudit(auditResponse);
                        } catch (err) {
                          const message =
